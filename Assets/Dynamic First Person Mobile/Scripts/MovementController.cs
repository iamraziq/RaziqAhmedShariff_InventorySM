        ...
        private float m_speed
        {
            get
            {
               // #if UNITY_EDITOR
                ...
                //#elif UNITY_ANDROID
                //        return Input_Crouch ? m_CrouchSpeed : Input_Sprint ? m_RunSpeed : 
                //            Input_Movement.magnitude != 0 ? m_WalkSpeed : 0.0f; 
               // #else
...
//#if UNITY_EDITOR
    ...
    //#endif
        ...
        private void Handle_InputMovement()
        {
            ...
            Vector2 Input = new Vector2(); // Initialize Input to (0, 0)
    //#if UNITY_EDITOR
   ...
   // #endif
            Vector3 WalkTargetDIrection = Input.y * transform.forward * m_speed + Input.x * transform.right * m_speed;
